...
export default function loadImages() {
  ...
  regionsWrapper.append(
    ...
    regionComponent('Kalos', 'The eighth region in the Pokemon series, Galar is one of the first to have more of its landmass added after the core title of the game, featured in the Crown Tundra and Isle of Armor expansions. Notably inspired by Great Britain (as if viewed upside-down), Galar incorporates cultural references from England, Wales, and Scotland into its topography and cities.', galarImg),
  );
